...
execute as @e[tag=sEnchCtr] at @s unless entity @e[tag=enchBook, distance=..2] run data merge entity @e[tag=ntrite, distance=..2, limit=1, sort=nearest] {PickupDelay:0s}
execute as @e[tag=sEnchCtr] at @s unless entity @e[tag=ntrite, distance=..2] run tag @s add itmPick

# Allows the item to be picked
execute as @e[tag=sEnchCtr] at @s unless entity @e[tag=enchBook, distance=..2] run tag @s add itmPick
execute as @e[tag=sEnchCtr] at @s unless entity @e[tag=ntrite, distance=..2] run data merge entity @e[tag=enchBook, distance=..2, limit=1, sort=nearest] {PickupDelay:0s}
