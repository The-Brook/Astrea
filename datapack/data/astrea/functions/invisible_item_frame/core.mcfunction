...
execute as @e[type=minecraft:item_frame, tag=!invItemF] at @s if entity @e[type=minecraft:potion, nbt={Item:{tag:{Potion:"minecraft:long_invisibility"}}}, distance=..1] run tag @s add invItemF
